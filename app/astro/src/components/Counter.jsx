...
export default function Counter({ initial = 0 }) {
    ...
    return (
        <div className="counter-col">
            {/* TOP HALF: Date pinned at the very top; Chip uses ALL remaining space and centers */}
        ...
        /* Top half: 2 rows => date (auto) + chip (1fr) */
        .top-half{
          display:grid;
          grid-template-rows:auto 1fr;
          gap: calc(var(--rhythm) * 1);
          /* IMPORTANT: no top margin here; outer .col-inner already adds identical top padding to match the left */
        }
        .date-banner{
          width:100%;
          margin:0; /* pin to top baseline */
        ...
        /* Chip fills leftover space and is perfectly centered */
        .chip-box{ display:flex; align-items:center; justify-content:center; min-height:0; }
        .chip-name{
          position:relative;
          font-family:'Pacifico', cursive;
          font-size: clamp(2.5rem, 5.8vw, 3.4rem); /* tuned for left/right height balance */
          line-height:1.3;
